...
const assumptionsSchema = z.object({
  ...
  powerUtilizationSolA:    z.number().min(1).max(100).optional().default(100),
  hoursPerDaySolA:         z.number().min(1).max(24).optional().default(24),
  powerTariffSolA:         z.number().min(0),
  pueCoolingFactorSolA:    z.number().min(1),
  ratedPowerSolBWatts:     z.number().min(0),
  powerUtilizationSolB:    z.number().min(1).max(100).optional().default(100),
  hoursPerDaySolB:         z.number().min(1).max(24).optional().default(24),
